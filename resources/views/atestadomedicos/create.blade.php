        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('atestadomedicos.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('usuario')) has-error @endif">
                    ...
                    <input type="text" id="datainicio-field" name="datainicio" class="form-control" value="{{ old("datainicio") }}"/>
                    ...
                    <input type="text" id="datafinal-field" name="datafinal" class="form-control" value="{{ old("datafinal") }}"/>
