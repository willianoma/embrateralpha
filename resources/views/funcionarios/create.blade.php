...
@section('header')
    <div class="page-header">
        <h7><i class="glyphicon glyphicon-plus"></i> {{trans('crud/funcionarios.title')}}
            / {{trans('crud/crud.create')}} </h7>
    </div>
@endsection
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('funcionarios.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  col-md-8 first-item @if($errors->has('nome')) has-error @endif">
                        ...
                        <div class="form-group last-item col-md-4 @if($errors->has('sexo')) has-error @endif">
                ...
                <!-- 4 Itens -->
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 minimal-padding @if($errors->has('data_admissao')) has-error @endif">
                            ...
                            <input type="date" data-date-format="DD MM YYYY" id="data_admissao-field"
                                   name="data_admissao"
                                   class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 minimal-padding first-item @if($errors->has('reservista')) has-error @endif">
                            ...
                            <input type="text" id="reservista-field" name="reservista" class="form-control"
                                   value="{{ old("reservista") }}" title="Apenas Números"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 minimal-padding @if($errors->has('bota')) has-error @endif">
                            ...
                            <input type="number" id="bota-field" name="bota" class="form-control"
                                   value="{{ old("bota") }}"
                                   placeholder="36"/>
                            @if($errors->has("bota"))
                        ...
                        <div class="form-group col-md-3 minimal-padding @if($errors->has('contato_emergencia')) has-error @endif">
                            ...
                            <input type="text" id="contato_emergencia-field" name="contato_emergencia"
                                   class="form-control"
                                   onkeyup="mascara( this, mtel );" maxlength="15"
                                   placeholder="(xx) xxxxx-xxxx"
                        ...
                        <div class="form-group col-md-3 minimal-padding last-item @if($errors->has('recebe_vale_transporte')) has-error @endif">
                            ...
                            <select id="recebe_vale_transporte-field" name="recebe_vale_transporte"
                                    class="form-control">
                                <option id="Nao" value="Nao">Não</option>
                                <option id="Sim" value="Sim">Sim</option>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 minimal-padding first-item @if($errors->has('cbo')) has-error @endif">
                            ...
                            <input type="text" id="cbo-field" name="cbo" class="form-control"
                                   value="{{ old("cbo") }}"/>
                            @if($errors->has("cbo"))
                        ...
                        <div class="form-group col-md-3 minimal-padding @if($errors->has('aso')) has-error @endif">
                            ...
                            <input type="text" id="aso-field" name="aso" class="form-control"
                                   value="{{ old("aso") }}"/>
                            @if($errors->has("aso"))
                        ...
                        <div class="form-group col-md-3 minimal-padding last-item @if($errors->has('preenchida_por')) has-error @endif">
                            ...
                            <input type="text" id="preenchida_por-field" readonly="" name="preenchida_por"
                                   readonly=""
