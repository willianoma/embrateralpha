...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="form-group @if($errors->has('cpf')) has-error @endif">
     ...
     <input type="text" id="cpf-field" name="cpf" class="form-control" value="{{ old("cpf") }}"/>
     @if($errors->has("cpf"))
   ...
   <div class="form-group @if($errors->has('rg')) has-error @endif">
     ...
     <input type="text" id="rg-field" name="rg" class="form-control" value="{{ old("rg") }}"/>
     @if($errors->has("rg"))
   ...
   <div class="form-group @if($errors->has('ctps')) has-error @endif">
     ...
     <input type="text" id="ctps-field" name="ctps" class="form-control" value="{{ old("ctps") }}"/>
     @if($errors->has("ctps"))
   ...
   <div class="form-group @if($errors->has('nascimento')) has-error @endif">
     ...
     <input type="text" id="nascimento-field" name="nascimento" class="form-control" value="{{ old("nascimento") }}"/>
   ...
   <div class="form-group @if($errors->has('data_admissao')) has-error @endif">
     ...
     <input type="text" id="data_admissao-field" name="data_admissao" class="form-control" value="{{ old("data_admissao") }}"/>
   ...
   <div class="form-group @if($errors->has('banco_conta')) has-error @endif">
     ...
     <input type="text" id="banco_conta-field" name="banco_conta" class="form-control" value="{{ old("banco_conta") }}"/>
   ...
   <div class="form-group @if($errors->has('banco_agencia')) has-error @endif">
     ...
     <input type="text" id="banco_agencia-field" name="banco_agencia" class="form-control" value="{{ old("banco_agencia") }}"/>
   ...
   <div class="form-group @if($errors->has('preenchida_por')) has-error @endif">
     ...
     <input type="text" id="preenchida_por-field" name="preenchida_por" class="form-control" value="{{ old("preenchida_por") }}"/>
